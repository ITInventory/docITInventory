...
<template>
 <main class="main"> 
    <h1 class="title">Django Setup</h1>
    <br>
    <p>On this project, its will use a local python environment for its to execute the django code due to its code language is python.
    </p>
    <br>
